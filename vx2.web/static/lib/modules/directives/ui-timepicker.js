...
/**
 * @author xuxihai
 * usage1: ui-timepicker
 * usage2: ui-timepicker='{"step":15,"show24Hours":false,"separator":"-","startTime":"06:00","endTime":"18:00"}'
 */
		...
		function () {
			return {
				...
				link: function (scope, element, attrs) {
					...
					var params = $.extend({}, defaults, vx.fromJson(attrs.uiTimepicker || {}));
...
(function ($) {
	...
	$._timePicker = function (elm, settings) {
		...
		$tpDiv.append($tpList);
		$tpDiv.width(elm.offsetWidth-1);
		$tpList.children().css("padding-left", $(elm).css("padding-left"));
